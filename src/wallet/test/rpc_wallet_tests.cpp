...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    COdynStockAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    COdynStockAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = COdynStockAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = COdynStockAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(COdynStockAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(COdynStockAddress(arr[0].get_str()).Get() == demoAddress.Get());
