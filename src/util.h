 ...
 */
#ifndef ODYNSTOCK_UTIL_H
#define ODYNSTOCK_UTIL_H
...
extern const char * const ODYNSTOCK_CONF_FILENAME;
extern const char * const ODYNSTOCK_PID_FILENAME;
...
{
    std::string s = strprintf("odynstock-%s", name);
