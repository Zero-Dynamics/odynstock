...
private:
    ...
    QLabel* viewLbl;
    OdynStockPushButton* proposalsBtn;
    OdynStockPushButton* paymentRequestsBtn;
    OdynStockPushButton* consultationsBtn;
    OdynStockPushButton* deploymentsBtn;
    OdynStockPushButton* consensusBtn;
    QLabel* filterLbl;
