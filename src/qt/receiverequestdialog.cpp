...
#include <config/odynstock-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatOdynStockURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + OdynStockUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatOdynStockURI(info));
}
