    ...
    case Encrypt:
        {
            ...
            QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
                    ...
                    "<br><br>" +
                    tr("Forgetting your passphrase and not having your mnemonic will make you <b>LOSE ACCESS TO ALL OF YOUR ODYNSTOCKS!!!</b>") +
                    "<br><br>" +
                    ...
                    if(model->setWalletEncrypted(true, newpass1))
                    {
                        QMessageBox::warning(this, tr("Wallet encrypted"),
                                ...
                                tr("%1 will close now to finish the encryption process. "
                                    ...
                                    "your odynstocks from being stolen by malware infecting your computer.").arg(tr(PACKAGE_NAME)) +
                                "</qt>");
                        QApplication::quit();
                    }
                    else
    ...
    case EncryptTx:
        {
            ...
            QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet txdata encryption"),
                    ...
                    "<br><br>" +
                    tr("Forgetting your pin and not having your mnemonic will make you <b>LOSE ACCESS TO ALL OF YOUR ODYNSTOCKS!!!</b>") +
                    "<br><br>" +
                    tr("Are you sure you wish to encrypt your wallet txdata?"),
                    QMessageBox::Yes|QMessageBox::Cancel,
                    QMessageBox::Cancel);
