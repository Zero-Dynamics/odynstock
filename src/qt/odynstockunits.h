...
#ifndef ODYNSTOCK_QT_ODYNSTOCKUNITS_H
#define ODYNSTOCK_QT_ODYNSTOCKUNITS_H
...
/** OdynStock unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class OdynStockUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit OdynStockUnits(QObject *parent);

    /** OdynStock units.
      @note Source: https://en.odynstock.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        // Base currencies
...
typedef OdynStockUnits::Unit OdynStockUnit;

#endif // ODYNSTOCK_QT_ODYNSTOCKUNITS_H
