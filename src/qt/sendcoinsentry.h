...
#ifndef ODYNSTOCK_QT_SENDCOINSENTRY_H
#define ODYNSTOCK_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending odynstocks.
...
#endif // ODYNSTOCK_QT_SENDCOINSENTRY_H
