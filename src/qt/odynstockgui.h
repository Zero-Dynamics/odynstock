...
#ifndef ODYNSTOCK_QT_ODYNSTOCKGUI_H
#define ODYNSTOCK_QT_ODYNSTOCKGUI_H
...
/**
  OdynStock GUI main class. This class represents the main window of the OdynStock UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class OdynStockGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit OdynStockGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~OdynStockGUI();
...
#endif // ODYNSTOCK_QT_ODYNSTOCKGUI_H
