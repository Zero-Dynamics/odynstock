...
#ifndef ODYNSTOCK_QT_SPLASHSCREEN_H
#define ODYNSTOCK_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. OdynStock Core initialization
...
#endif // ODYNSTOCK_QT_SPLASHSCREEN_H
