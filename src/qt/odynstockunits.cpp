...
OdynStockUnits::OdynStockUnits(QObject *parent):
    QAbstractListModel(parent),
    unitlist(availableUnits())
{
}

QList<OdynStockUnits::Unit> OdynStockUnits::availableUnits()
{
...
bool OdynStockUnits::valid(int unit)
{
    switch(unit)
    {
        case ODYNS:
...
QString OdynStockUnits::name(int unit, bool fPrivate)
{
    switch(unit)
    {
...
QString OdynStockUnits::description(int unit)
{
    switch(unit)
    {
...
qint64 OdynStockUnits::factor(int unit)
{
...
int OdynStockUnits::decimals(int unit)
{
    switch(unit)
    {
        case ODYNS: return 8;
...
QString OdynStockUnits::format(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators, bool fPretty)
{
...
QString OdynStockUnits::pretty(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators)
{
...
// appropriate.
QString OdynStockUnits::formatWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool fPrivate)
{
    return QString("%1 %2").arg(format(unit, amount, plussign, separators), name(unit, fPrivate));
}

QString OdynStockUnits::prettyWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool fPrivate)
{
    return QString("%1 %2").arg(pretty(unit, amount, plussign, separators), name(unit, fPrivate));
}

QString OdynStockUnits::formatHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool removeTrailing, bool fPrivate)
{
...
bool OdynStockUnits::parse(int unit, const QString &value, CAmount *val_out)
{
...
QString OdynStockUnits::getAmountColumnTitle(int unit)
{
    QString amountTitle = QObject::tr("Amount");
    if (OdynStockUnits::valid(unit))
    {
        amountTitle += " ("+OdynStockUnits::name(unit) + ")";
    }
    return amountTitle;
}

int OdynStockUnits::rowCount(const QModelIndex &parent) const
{
    Q_UNUSED(parent);
    return unitlist.size();
}

QVariant OdynStockUnits::data(const QModelIndex &index, int role) const
{
    int row = index.row();
...
CAmount OdynStockUnits::maxMoney()
{
    return MAX_MONEY;
}
