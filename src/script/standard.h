...
#ifndef ODYNSTOCK_SCRIPT_STANDARD_H
#define ODYNSTOCK_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a COdynStockAddress
 */
...
#endif // ODYNSTOCK_SCRIPT_STANDARD_H
