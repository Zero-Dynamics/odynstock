...
#ifndef ODYNSTOCK_SCRIPT_SCRIPT_H
#define ODYNSTOCK_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, OdynStock always counted CHECKMULTISIGs
...
#endif // ODYNSTOCK_SCRIPT_SCRIPT_H
