...
#ifndef ODYNSTOCK_KEYSTORE_H
#define ODYNSTOCK_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/odynstock/bips/blob/master/bip-0013.mediawiki
