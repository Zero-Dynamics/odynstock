# OdynStock v4.3.0 Release Notes

## Introduces OpenAlias:

This PR https://github.com/odynstock/odynstock-core/pull/213 completes the implementation of the OpenAlias protocol into the OdynStock Core client.
...
- OdynStock enforces by default the use of DNSSEC
...
The secp256k1 lib from bitcoin 16.2 release was included into the codebase. While there are a number of improvements, the update was mainly needed due to the better build options for developers and allows newer OS's to build. This reduces the friction in getting setup and working with OdynStock

# Transalations

The Wallet GUI is now fully translated to Spanish and Italian.

### Other modifications in the OdynStock client:

- New RPC command `resolveopenalias` resolves an OpenAlias address to a OdynStock address
