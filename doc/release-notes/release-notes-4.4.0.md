# OdynStock v4.4.0 Release Notes
...
You can read more about [NPIP0003 on the NPIP GitHub](https://github.com/odynstock/npips/blob/master/npip-0003.mediawiki).
...
You can read more about [NPIP0005 on the NPIP GitHub](https://github.com/odynstock/npips/blob/master/npip-0005.mediawiki).
...
```
createproposal odynstockaddress amount duration "desc" fee

Arguments:
1. "odynstockaddress" (string, required) The odynstock address where coins would be sent if the proposal is approved.
