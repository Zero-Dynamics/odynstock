...
# OdynStock v4.2.0 Release Notes
...
- Accepts URI to sign messages.
    - URIs of the format odynstock:http://domain/something/?a=odynstock_address&m=some_message will make the wallet to sign “some_message” and return the produced signature as a POST request to the URL specified in the URI.
...
- odynstock-tx tool has been updated to use odynstock’s own transaction structure
