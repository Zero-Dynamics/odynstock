...
class ColdStakingSpending(OdynStockTestFramework):
    ...
    def run_test(self):
        ...
        # get wallet balance and staking weight before sending some odynstock
        ...
        # staking weight will be 0 as our recieved BLOCK_REWARD odynstock isn't mature enough to count towards
        # our staking weight
