...
class WalletTest (OdynStockTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 0DYNS from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 0DYNS with subtract fee from amount
        ...
        # Sendmany 10 0DYNS with subtract fee from amount
