...
unlocked to sign the OdynStock-Qt.app bundle.
...
allowing somebody to distribute a OdynStock-Qt.app or odynstock-qt-setup.exe with a valid
...
that the odynstock-qt.exe file inside the installer had not been tampered with.
